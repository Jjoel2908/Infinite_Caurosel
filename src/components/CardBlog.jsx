...
export const CardBlog = ({ blog }) => {
	return (
		<div className='h-full w-[480px] m-2 flex-shrink-0 cursor-pointer'>
			<div className='rounded-3xl overflow-hidden mb-4 relative h-[298px]'>
				<img src={`/img/blogpost${blog.id}.avif`} alt={blog.title} />
			</div>
